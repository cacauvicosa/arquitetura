...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str())) {
      ...
      client.subscribe("fita/carroazul");      
    } else {
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if ( Topic.equals("fita/carroazul") ) {
    PIN_P3 = !PIN_P3;
  }
...
void loop() {
    ...
    if ( (flag_sw3==1) && (PIN_P3==0) ) {flag_sw3=0;speed3+=ACEL;};
    if ( (flag_sw3==0) && (PIN_P3==1) ) {flag_sw3=1;};
    ...
    if (loop3>loop_max) {for(int i=0;i<NPIXELS;i++){track.setPixelColor(i, track.Color(0,0,255));}; track.show();
                                                    winner_fx();loop1=0;loop2=0;loop3=0;dist1=0;dist2=0;dist3=0;speed1=0;
                                                    speed2=0;speed3=0;timestamp=0;
                                                    start_race();
                                                   }
    ...
    if (draworder==0) {draw_car1();draw_car2();draw_car3();}
        else {draw_car2();draw_car3();draw_car1();}   
